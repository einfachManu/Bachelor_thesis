############################################################
#           MARINE SNOW STUDY – JSONL VERSION
#           KEINE DATENBANK, 100% LOKAL, FEHLERFREI
############################################################
...
tag1_questions = [
    {"nr": 0, "type": "likert", "text": "Wie sicher fühlst du dich, den Stoff verstanden zu haben?"},
    {"nr": 1, "type": "single",
     "text": "Welche Aussage beschreibt Meeresschnee am besten?",
     "options": [
         "Kleine Aggregate <500 µm",
         "Besteht aus Mikroorganismen und Tonmineralien",
         "Nur eine Aggregatart",
         "Immer strangförmig"
     ]},
    {"nr": 2, "type": "single",
     "text": "Was verringert die Menge von Meeresschnee?",
     "options": [
         "Tiere fressen ihn",
         "Mehr Aggregation",
         "Mehr Klebstoffe",
    ...
    {"nr": 3, "type": "multi",
     "text": "Welche Probleme treten beim Sammeln auf? (2 richtig)",
     "options": [
         "Zerbrechlich",
         "Setzt sich schnell ab",
         "Druck zerstört es in Küstenwasser",
         "Bleibt beim Transport stabil"
     ]},
    {"nr": 4, "type": "short",
     "text": "Nenne zwei Wege, wie Meeresschnee entsteht."},
    {"nr": 5, "type": "paragraph",
     "text": "Warum findet man manchmal weniger Meeresschnee als erwartet? Nenne zwei Gründe."},
    {"nr": 6, "type": "paragraph",
     "text": "Warum verschwindet Meeresschnee schnell? Nenne zwei Gründe."},
    {"nr": 7, "type": "short",
     "text": "Warum ist Meeresschnee wichtig? Nenne zwei Punkte."}
]
...
if st.session_state.phase == "learning":
    ...
    def generate_answer(user_text, level):
        # Rechtschreibung
    ...
    {raw_answer}
    """
        raw_answer = generate_answer(user_text, level)
        styled = enforce_length(raw_answer)
...
if st.session_state.phase == "end":
    ...
    In 24 Stunden erhältst du den zweiten Teil der Umfrage.
    Dieser dauert maximal 5 Minuten.
    """)
